...
function renderSounds(filter = '') {
    ...
    finalSound.forEach(sound => {
        ...
        button.onclick = () => {
            ...
            const audio = new Audio("https://cdn.jsdelivr.net/Happybuterfly4/Asstes/extras/SoundBoard/"+sound.mp3);
            audio.play();
...
function rightClickPanel(event, button, sound) {
    ...
    download.onclick = () => {
        ...
        link.href = 'https://cdn.jsdelivr.net/Happybuterfly4/Asstes/extras/SoundBoard/'+sound.mp3;
